...
5. [云端功能方案](cloud_architecture_plan.md)：账号、自建云端、多车共享、官方云桥接和服务生态规划。
6. [Android 构建说明](android_build_notes.md)：Windows/Android 构建时的已知问题和处理建议。
...
| 云端方案 | [cloud_architecture_plan](cloud_architecture_plan.md) | 记录自建云端、官方云桥接、多车共享和服务生态路线 |
...
- 账号、云同步、官方云桥接和服务生态规划更新到 [cloud_architecture_plan](cloud_architecture_plan.md)。
