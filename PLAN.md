...
```text
完全复刻 % = 0.50×84.6 + 0.25×100.0 + 0.25×100.0
            = 42.30 + 25.00 + 25.00
            = 92.3%

完美复刻 % = 0.70×92.3 + 0.30×0.0
            = 64.6%
...
| 指标 | **当前** | 目标门槛 |
|------|----------|----------|
| **完全复刻** | **92.3%** | **100%** 才可称「主路径完全复刻可演示」 |
| **完美复刻** | **64.6%** | **100%** 才可称「深度对齐」 |
...
**口径一句话：** P1/P2 已关门；**完全复刻差 P0-A5/B5 真机**（无真车无法诚实 [x]）；P3/P4 为完美/工程。
...
| 阶段 | 当前 Σ系数怎么来的（便于手算） |
|------|--------------------------------|
| P0 | A1–A4x B1–B4x C1–C3x + A3x = 11×1.0；A5 B5 仍 0 → **11.0** / 13 |
| P1 | 全 `[x]` → **6.0** / 6 |
| P2 | 全 `[x]` → **7.0** / 7 |
| P3 | 全 0 |
| P4 | 仅 P4-5 `[x]` → **1.0** / 6 |
